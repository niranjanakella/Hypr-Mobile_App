  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.secondryContainer}>
            ...
            <View style={styles.title_container}>
              ...
              <Text style={styles.otp_desc}>
                ...
                <Text
                  ...
                  {' '}
                  {props.route.params.userData.f_email}
                </Text>
              </Text>
            </View>
        ...
        <View
          style={{
            marginHorizontal: constants.width_dim_percent * 5,
            bottom: 0,
            left: 0,
            right: 0,
            marginBottom: constants.height_dim_percent * 45,

            position: 'absolute',
          }}>
          <Components.PrimaryButton onPress={handleVerifyOtp} title="VERIFY" />
        </View>
        ...
        <View
          style={{
            ...
            left: 0,
            right: 0,
            marginBottom: constants.height_dim_percent * 40,
            position: 'absolute',
          }}>
