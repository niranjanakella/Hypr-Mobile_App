    ...
    if (!state.isAgree) {
      ...
      if (!constants.AppConstant.PASSWORD_REGEX.test(state.password)) {
        setState({
          ...
          passwordErr: true,
          passwordErrMsg:
            'Password must contain  at least 8 letters,0 small letters ,0 capital letters, 0 numbers, 0 special characters',
        });
        return 0;
      }
              ...
              <Components.PrimaryPhoneInput
                ...
                onSelect={country => {
                  setState({
                    ...
                    countryCode: `+${
                      country.callingCode[0] ? country.callingCode[0] : '44'
                    }`,
            ...
            <View
              ...
              <View
                ...
                <Text
                  onPress={() =>
                    NavigationService.navigate(
                      constants.ScreensName.TermsCondition.name,
                      null,
                    )
                  }
                ...
                <Text
                  onPress={() =>
                    NavigationService.navigate(
                      constants.ScreensName.PrivacyPolicy.name,
                      null,
                    )
                  }
                  style={styles.linkText}>
