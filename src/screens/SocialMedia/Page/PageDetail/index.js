        ...
        <>
            ...
            <SafeAreaView style={styles.container}>
                <Components.PrimaryHeader
                    ...
                    title={props.page.selectedPage.f_PageName}
                />
                <ScrollView
                    style={{ flex: 1 }}
                >
                    <View style={{
                        ...
                        <Image
                            source={props.page.selectedPage.f_PageCoverPic ? { uri: props.page.selectedPage.f_PageCoverPic[0] } : constants.Images.logo}
                        ...
                        <View style={styles.profileImageContainer}>
                            <Image
                                source={props.page.selectedPage.f_PageProfilePic ? { uri: props.page.selectedPage.f_PageProfilePic[0] } : constants.Images.user}
                    ...
                    >
                        <View style={styles.paddingHorizontal15}>
                            <Text style={styles.text18bold}>{props.page.selectedPage.f_PageName}</Text>
                            <Text style={{ textAlign: "center" }}>{props.page.selectedPage.f_PageAbout}</Text>
                        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(SocialPageDetail);