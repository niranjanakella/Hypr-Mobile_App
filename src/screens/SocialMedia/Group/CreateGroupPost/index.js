...
import { uploadGroupPostCreateImage, addGroupPost } from '../../../../actions/group';
import * as NavigationService from '../../../../navigation/NavigationService';
import { BackgroundCarousel } from '../../../../components/Slider';

const SocialCreateGroupPost = (props) => {
    ...
    const handleAddPost = async () => {
        ...
        await props.dispatch(uploadGroupPostCreateImage(payload))
    }
    return (
        <>
...
export default connect(mapStateToProps, mapDispatchToProps)(SocialCreateGroupPost);